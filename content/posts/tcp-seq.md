...
服务端解析收到的分组发现这是一个 Seq=1 的长度为 935 的分组，即收到的最后一个字节的序号为 935。为了答复确认收到该分组，将即将发送的分组 ACK 标记为激活，Ack 置为 936。
...
![image-20210422145339782](/images/tcp-seq.assets/image-20210422145339782.png)
